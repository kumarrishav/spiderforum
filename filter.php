...
$profile=$_GET['id'];
$sql="SELECT user.username,user.user_id,ques_desc,ques_title,ques_id,tag1,tag2,tag3,tag4,tag5,Newtag,profile, use_id,stamp FROM user,question WHERE user.user_id=question.use_id AND profile='$profile'";
...
if($loop === FALSE) {
 ...
 echo "<b>PROFILE:-</b><font size='4' color='red'> <i><u>".$profile."</u></i></font></br>";
